...
(function(root, factory) {
    ...
    AssociatedModel = Backbone.AssociatedModel = Backbone.Associations.AssociatedModel = BackboneModel.extend({
        ...
        on: function (name, callback, context) {
            ...
            if (Backbone.Associations.EVENTS_NC) {
                return result;
            }
        ...
        off: function (name, callback, context) {
            ...
            // No optimization possible if nested-events is wanted by the application
            if (Backbone.Associations.EVENTS_NC) {
                return BackboneEvent.off.apply(this, arguments);
            }
        ...
        _setAttr:function (attributes, options) {
            ...
            if (this.relations) {
                ...
                _.each(this.relations, function (relation) {
                    ...
                    if (attributes.hasOwnProperty(relationKey)){this._setupParents(attributes[relationKey], this.attributes[relationKey]);}
                }, this);
            }
        ...
        _bubbleEvent:function (relationKey, relationValue, eventArguments) {
            ...
            if (!Backbone.Associations.EVENTS_NC && !endPoints[sourceKey]) {
                return;
            }
            ...
            if (this._isEventAvailable.call(this, _proxyCalls, eventPath)) {
                return this;
            }
        ...
        _transformRelatedModel: function (relation, attributes) {
            ...
            if (relatedModel && !(relatedModel.prototype instanceof BackboneModel)){relatedModel = _.isFunction(relatedModel) ?
        ...
        _transformCollectionType: function (relation, relatedModel, attributes) {
            ...
            if (collectionType && !(collectionType.prototype instanceof BackboneCollection)){collectionType = _.isFunction(collectionType) ?
